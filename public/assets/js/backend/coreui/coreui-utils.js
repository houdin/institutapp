!(function (e, t) {
    "object" == typeof exports && "object" == typeof module
        ...
        ? (exports.Utils = t())
        : ((e.coreui = e.coreui || {}), (e.coreui.Utils = t()));
})(this, function () {
    return (function (e) {
        var t = {};
        function r(n) {
        ...
        function (e, t, r) {
            ...
            var n = function e(t, r) {
                    for (var n = 0, o = Object.keys(r); n < o.length; n++) {
                        var c = o[n];
                        r[c] instanceof Object &&
                            Object.assign(r[c], e(t[c], r[c]));
                    }
                ...
                o = function () {
                    for (
                        ...
                        for (
                            var o = t[n].cssRules, c = o.length - 1;
                            c > -1;
                            c--
                        )
                ...
                u = function (e) {
                    ...
                    if (!e.match(/^#(?:[0-9a-f]{3}){1,2}$/i))
                        throw new Error(
                            "".concat(e, " is not a valid hex color")
                        );
                    return (
                        7 === e.length
                ...
                p = function (e) {
                    ...
                    if (!t)
                        throw new Error(
                            "".concat(e, " is not a valid rgb color")
                        );
