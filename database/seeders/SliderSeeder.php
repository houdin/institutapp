...
class SliderSeeder extends Seeder
{
    ...
    public function run()
    {
        $slide_1 = [
            'name' => 'Slide 1',
            'content' => '{"hero_text":"Inventive Solution for Education","sub_text":"Education and Training Organization","buttons":[{"label":"Our Formations","link":"http://laravel-lms.test/formations"}]}',
        ...
        $slide_2 = [
            'name' => 'Slide 2',
            'content' => '{"hero_text":"Browse The Best Formations","sub_text":"Education and Training Organization","widget":{"type":1}}',
