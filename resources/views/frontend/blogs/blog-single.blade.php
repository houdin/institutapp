            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="blog-details-content">
                        <div class="post-content-details">
                            @if($blog->image )
                                ...
                                <div class="blog-detail-thumbnile mb35">
                                    <img src="{{asset('storage/uploads/blogs/'.$blog->image->name)}}" alt="">
                                </div>
                            @endif

                            <h2 class="color-base-3">{{$blog->title}}</h2>
                        ...
                        <div class="author-comment d-inline-block p-3  bg-black-0 h-100 d-table text-center mx-auto">

                            <span class="mt-2  d-table-cell align-middle color-white-1">BY:  <b>{{$blog->author->name}}</b></span>
                        </div>

                        <div class="next-prev-post">
                            @if($previous != "")
                                <div class="next-post-item float-left">
                                    <a href="{{route('blogs.index',['slug'=>$previous->slug.'-'.$previous->id ])}}" class="color-white-1"><i
                            ...
                            @if($next != "")
                                <div class="next-post-item float-right">
                                    <a href="{{route('blogs.index',['slug'=>$next->slug.'-'.$next->id ])}}" class="color-white-1">Next Post<i
                    ...
                    <div class="blog-recent-post about-teacher-2">
                        <div class="section-title-2  headline text-left">
                            <h2 class="color-white-1"> @lang('labels.frontend.blog.related_news')</h2>
                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="blog-post-img-content">
                                                <div class="blog-img-date relative-position">
                                                    <div class="blog-thumnile" @if($item->image ) style="background-image: url({{asset('assets/images/blogs/'.$item->image)}})" @endif></div>
                                ...
                                <div class="teacher-faq-form">
                                    <form method="POST" action="{{route('blogs.comment',['id'=>$blog->id])}}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="color-white-1" name="comment" required class="mb-0" id="comment" rows="2"
                                                      cols="15"></textarea>
