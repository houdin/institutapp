                                                        ...
                                                        <div class="best-formation-pic relative-position"
                                                            ...
                                                            <div class="formation-details-btn">
                                                                <a class="text-uppercase"
                                                                   href="{{ route('formations.show', [$formation->slug]) }}">@lang('labels.frontend.search_result.formation_detail')
                                    ...
                                    @if(count($formations) > 0)
                                        <table>
                                            <tr class="list-head text-uppercase">
                                                <th>@lang('labels.frontend.search_result.formation_name')</th>
                                                <th>@lang('labels.frontend.search_result.formation_type')</th>
                                                    ...
                                                    <td>
                                                        <div class="formation-list-img-text">
                                                            <div class="formation-list-img"
                                                                 @if($formation->image ) style="background-image: url({{asset('storage/uploads/'.$formation->image->name)}})" @endif >
                                                            </div>
                                                            <div class="formation-list-text">
                                                                ...
                                                                <span class="formation-category bold-font"><a
                                                                            href="{{ route('formations.show', [$formation->slug]) }}">@if($formation->free == 1)
                ...
                <div class="col-md-3">
                    <div class="side-bar">
                        ...
                        <div class="side-bar-widget  first-widget">
                            <h2 class="widget-title text-capitalize">@lang('labels.frontend.formation.find_your_formation')</h2>
                                ...
                                <form action="{{route('search-formation')}}" method="get">
                                    ...
                                    <div class="filter-search mb20">
                                        ...
                                        <input type="text" class="" value="{{(request('q') ? request('q') : old('q'))}}"
                                               name="q" placeholder="{{trans('labels.frontend.formation.looking_for')}}">
                                    </div>
                                        ...
                                        <div class="latest-news-area">
                                            ...
                                            @if($item->image )
                                                <div class="latest-news-thumbnail relative-position"
                                                     style="background-image: url({{asset('storage/uploads/'.$item->image->name)}})">
                                                    <div class="blakish-overlay"></div>
                                                </div>
                                            @endif
                                            <div class="date-meta">
                            ...
                            <div class="side-bar-widget">
                                ...
                                <div class="featured-formation">
                                    <div class="best-formation-pic-text relative-position pt-0">
                                        <div class="best-formation-pic relative-position "
                                             @if($global_featured_formation->image ) style="background-image: url({{asset('storage/uploads/'.$global_featured_formation->image->name)}})" @endif>
