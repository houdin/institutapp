<ul class="nav nav-right justify-content-end h-100">
    ...
    @if (auth()->check())
        <li class="nav-item menu-item-has-children ul-li-block">
            <div class="log-in">
                <a href="#!">{{ auth()->user()->first_name }}<span
                ...
                <ul class="sub-menu">
                    ...
                    @endcan
                    <li>
                        <router-link to="/user/user-account">My account</router-link>
                    </li>
                    <li>
                        <router-link to="/user/user-account">Factures</router-link>
                    </li>
                    ...
                    <li>
                        ...
                        <a href=""
                            onclick="event.preventDefault(); document.getElementById('logoutform').submit();">Se
                            Deconnecter</a>
