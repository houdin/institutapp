            ...
            <div class="">
                ...
                @foreach ($second_menus as $label => $item)
                    <li class="nav-item second">
                        <router-link to="{{ $item }}" class="nav-link second"><span>{{ $label }}</span>
                        </router-link>
                    </li>
                @endforeach
            ...
            @if (auth()->check())
                <li class="">
                    ...
                    <ul class="">
                        ...
                        <li>
                            <router-link to="{{ route('logout') }}">@lang('navs.general.logout')</router-link>
                        </li>
                    </ul>
                </li>
            @else
                <li>
                    <div class="">
                        <router-link id="openLoginModal" data-target="#myModal" to="#">@lang('navs.general.login')
                        </router-link>
                        <!-- The Modal -->
                    </div>
                </li>
