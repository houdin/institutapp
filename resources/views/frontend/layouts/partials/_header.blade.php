                        ...
                        <div class="navbar-default">
                            <div class="navbar-header float-left">
                                <a class="navbar-brand text-uppercase" href="{{ url('/') }}">
                                    ...
                                    <img src="{{ asset('assets/images/logos/' . config('app.logo_w_image')) }}"
                                        alt="logo">
                                </a>
                            </div><!-- /.navbar-header -->
                                                    ...
                                                    <li class="menu-item-has-children ul-li-block">
                                                        ...
                                                        <ul class="sub-menu">
                                                            ...
                                                            @foreach ($custom_menus[$key] as $label => $item)
                                                                @include('frontend.layouts.partials._dropdown',
                                                                    [$label, $item])
                                                            @endforeach
                            ...
                            <ul class="nav justify-content-end">
                                ...
                                <navbar-cart :cart="cart" @remove-item="removeItem"
                                    @update-quantity="updateCart">
                                ...
                                @if (auth()->check())
                                    <li class="menu-item-has-children ul-li-block">
                                        <a href="#!">{{ $logged_in_user->name }}<span
                                                class="ml-2 d-inline-block border border-warning rounded-circle"
                                                style="width:30px; height:30px; padding-top:3px"><i
                                                    class="fas fa-user ml-2"></i></span> </a>
                                        <ul class="sub-menu">
                                            @can('view backend')
                                                <li>
                                        ...
                                        <div class="">
                                            ...
                                            @foreach ($second_menus as $label => $item)
                                                <li class="nav-item second">
                                                    <a href="{{ asset($item) }}"
                                                        class="nav-link second"><span>{{ $label }}</span></a>
                                                </li>
                                            @endforeach
