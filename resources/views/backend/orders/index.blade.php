...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="page-title d-inline mb-0">@lang('backend/labels.backend.orders.title')</h3>
                ...
                <ul class="list-inline">
                    <li class="list-inline-item">
                        <a href="{{ route('admin.orders.index') }}"
                           style="{{ request('offline_requests') == 1 ? '' : 'font-weight: 700' }}">{{trans('backend/labels.general.all')}}</a>
                    </li>
                    |
                    <li class="list-inline-item">
                        <a href="{{ route('admin.orders.index') }}?offline_requests=1"
                           style="{{ request('offline_requests') == 1 ? 'font-weight: 700' : '' }}">{{trans('backend/labels.backend.orders.offline_requests')}}</a>
                    </li>
                </ul>
            </div>
            <div class="table-responsive">
                <table id="myTable" class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <th>@lang('backend/labels.backend.orders.fields.amount') <small>(in {{$appCurrency['symbol']}})</small></th>
                        <th>@lang('backend/labels.backend.orders.fields.payment_status.title')</th>
                        <th>@lang('backend/labels.backend.orders.fields.user_email')</th>
