...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="page-title d-inline">@lang('backend/labels.backend.tax.title')</h3>
                    ...
                    <div class="table-responsive">
                        <table id="myTable"
                            ...
                            <tr>
                                ...
                                <th>@lang('backend/labels.backend.tax.fields.name')</th>
                                <th>@lang('backend/labels.backend.tax.fields.rate') (in %)</th>
                                <th>@lang('backend/labels.backend.tax.fields.status')</th>
...
@push('after-scripts')
    ...
    <script>
        ...
        $(document).on('click', '.switch-input', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('admin.tax.status', ['id' => "+ id + "]) }}",
                data: {
                    _token:'{{ csrf_token() }}',
                    id: id,
                },
