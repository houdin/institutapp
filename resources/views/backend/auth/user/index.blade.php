...
@section('title', app_name() . ' | ' . __('backend/labels.backend.access.users.management'))
            ...
            <div class="row">
                <div class="col-sm-7">
                    <h4 class="card-title mb-0">
                        {{ __('backend/labels.backend.access.users.management') }}
                        <small class="text-muted">{{ __('backend/labels.backend.access.users.active') }}</small>
                    </h4>
                </div>
                <!--col-->
                ...
                <div class="col-sm-5">
                    <select name="roles" id="roles" class="form-control d-inline w-75">
                        ...
                        <option value="">{{ __('backend/labels.backend.access.users.select_role') }}</option>
                        ...
                        <table id="myTable" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>@lang('backend/labels.backend.access.users.table.name')</th>
        ...
        $(document).ready(function() {
            ...
            var myTable = $('#myTable').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: "permissions_label",
                        name: "permissions.name"
                    },
                    {
                        data: "social_buttons",
                        name: "social_accounts.provider",
                        "searchable": false
                    },
                    {
                        data: "last_updated",
