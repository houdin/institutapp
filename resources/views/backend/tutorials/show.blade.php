                ...
                <div class="col-12">
                    ...
                    <table class="table table-bordered table-striped">
                        <tr>
                            ...
                            <td>
                                @foreach ($tutorial->teachers as $singleTeachers)
                        ...
                        <tr>
                            ...
                            <td>
                                @if($tutorial->published == 1)
                                    <a target="_blank"
                                       href="{{ route('formations.show', [$tutorial->slug]) }}">{{ $tutorial->title }}</a>
                                @else
                                    {{ $tutorial->title }}
                                @endif
                            </td>
                        ...
                        <tr>
                            ...
                            <td>{{ ($tutorial->free == 1) ? trans('backend/labels.backend.formations.fields.free') : $tutorial->price.' '.$appCurrency['symbol'] }}</td>
                        </tr>
                        <tr>
                            <th>@lang('backend/labels.backend.formations.fields.formation_image')</th>
                            <td>@if($tutorial->image)<a
                                        href="{{ featured_image_url($tutorial, 1) }}"
                                        target="_blank"><img
                                            src="{{ featured_image_url($tutorial, 1) }}"
                            ...
                            <td>
                                @if($tutorial->mediaVideo !=  null )
                                    <p class="form-group mb-0">
                                        <a href="{{$tutorial->mediaVideo->url}}"
                                           target="_blank">{{$tutorial->mediaVideo->url}}</a>
                                    </p>
                                @else
                                    <p>No Videos</p>
                                @endif
                        ...
                        <tr>
                            ...
                            <td>{{ Form::checkbox("published", 1, $tutorial->published == 1 ? true : false, ["disabled"]) }}</td>
                        </tr>
