        ...
        <div class="card-header">
            ...
            @can('question_create')
                <div class="float-right">
                    <a href="{{ route('admin.questions.create') }}" class="btn btn-success">@lang('backend/strings.backend.general.app_add_new')</a>
        ...
        <div class="card-body table-responsive">
            <div class="row">
                <div class="col-12 col-lg-6 form-group">
                    {!! Form::label('test_id', trans('backend/labels.backend.questions.test'), ['class' => 'control-label']) !!}
                    {!! Form::select('test_id', $tests, request('test_id') ? request('test_id') : old('test_id'), [
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('change', '#test_id', function(e) {
                ...
                window.location.href = "{{ route('admin.questions.index') }}" + "?test_id=" + formation_id
            });
            @can('question_delete')
                @if (request('show_deleted') != 1)
                    $('.actions').html('<a href="' + '{{ route('admin.questions.mass_destroy') }}' +
