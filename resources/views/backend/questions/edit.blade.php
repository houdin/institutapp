...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="page-title float-left mb-0">@lang('backend/labels.backend.questions.edit')</h3>
    ...
    @foreach ($question->options as $key=>$option)
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12 form-group">
                        {!! Form::label('option_text_' . $option->id, trans('backend/labels.backend.questions.fields.option_text').'*', ['class' => 'control-label']) !!}
                ...
                <div class="row">
                    <div class="col-12 form-group">
                        {!! Form::label('explanation_' . $option->id, trans('backend/labels.backend.questions.fields.option_explanation').'*', ['class' => 'control-label']) !!}
                ...
                <div class="row">
                    <div class="col-12 form-group">
                        {!! Form::label('correct_' . $key, trans('backend/labels.backend.questions.fields.correct'), ['class' => 'control-label']) !!}
