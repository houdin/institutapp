...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="page-title d-inline">@lang('backend/labels.backend.bundles.create')</h3>
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-10 form-group">
                    ...
                    {!! Form::select('formations[]', $formations, old('formations'), ['class' => 'form-control select2 js-example-placeholder-multiple', 'multiple' => 'multiple']) !!}
                </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-6 form-group">
                    ...
                    {!! Form::text('title', old('title'), ['class' => 'form-control', 'placeholder' => trans('backend/labels.backend.bundles.fields.title'), 'required' => false]) !!}
                </div>
                <div class="col-12 col-lg-6 form-group">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4 form-group">
                    {!! Form::label('formation_image',  trans('backend/labels.backend.bundles.fields.formation_image'), ['class' => 'control-label']) !!}
                    {!! Form::file('formation_image',  ['class' => 'form-control', 'accept' => 'image/jpeg,image/gif,image/png']) !!}
                ...
                <div class="col-12 col-lg-4  form-group">
                    ...
                    {!! Form::text('start_date', old('start_date'), ['class' => 'form-control date','pattern' => '(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))', 'placeholder' => trans('backend/labels.backend.bundles.fields.start_date').' (Ex . 2019-01-01)', 'autocomplete' => 'off']) !!}
