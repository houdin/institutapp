...
<body>
    ...
    <script>
        ...
        $('li.nav-group').on('click', function() {
    ...
    <script src="{{ asset('assets/js/backend/vfs_fonts.js') }}"></script>
    ...
    <script src="{{ asset('assets/js/backend/select2.full.min.js') }}" type="text/javascript"></script>
    <!-- Plugins and scripts required by this view-->
    {{-- <script src="{{asset('assets/js/backend/coreui/chart.min.js')}}"></script>
            <script src="{{asset('assets/js/backend/coreui/coreui-chart.js')}}"></script>
            <script src="{{ asset('assets/js/backend/coreui/coreui-utils.js') }}"></script>
            <script src="{{ asset('assets/js/backend/coreui/main.js') }}"></script> --}}
    <script>
