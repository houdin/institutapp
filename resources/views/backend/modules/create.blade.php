...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.modules.store'], 'files' => true,]) !!}
    {!! Form::hidden('model_id',0,['id'=>'module_id']) !!}

    <div class="card">
        <div class="card-header">
            <h3 class="page-title float-left mb-0">@lang('backend/labels.backend.modules.create')</h3>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12 col-lg-6 form-group">
                    ...
                    {!! Form::select('formation_id', $formations,  (request('formation_id')) ? request('formation_id') : old('formation_id'), ['class' => 'form-control select2']) !!}
                </div>
                <div class="col-12 col-lg-6 form-group">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6 form-group">
                    ...
                    {!! Form::file('module_image', ['class' => 'form-control' , 'accept' => 'image/jpeg,image/gif,image/png']) !!}
            ...
            <div class="row">
                <div class="col-12 form-group">
                    {!! Form::label('audio_files', trans('backend/labels.backend.modules.fields.add_audio'), ['class' => 'control-label']) !!}
                    {!! Form::file('add_audio', [
                        'class' => 'form-control file-upload',
                         'id' => 'add_audio',
                        'accept' => "audio/mpeg3"
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-3 form-group">
                    <div class="checkbox">
                        ...
                        {!! Form::label('published', trans('backend/labels.backend.modules.fields.published'), ['class' => 'checkbox control-label font-weight-bold']) !!}
                    </div>
                </div>
