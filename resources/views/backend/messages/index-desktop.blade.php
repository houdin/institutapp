...
@section('content')
    <div class="card message-box">
        <div class="card-header">
            <h3 class="page-title mb-0">@lang('backend/labels.backend.messages.title')
                ...
                <div class="inbox_msg">
                        ...
                        <div class="headind_srch">
                            ...
                            <div class="recent_heading btn-sm btn btn-dark">
                                <a class="text-decoration-none" href="{{route('admin.messages')}}">
                                    <h5 class="text-white mb-0"><i class="icon-plus"></i>&nbsp;&nbsp; @lang('backend/labels.backend.messages.compose')</h5>
                                </a>
                            </div>
                            @endif
                            <div class="srch_bar @if(!request()->has('thread')) text-left @endif">
                                <div class="stylish-input-group">
                                    <input type="text" class="search-bar" id="myInput" placeholder="@lang('backend/labels.backend.messages.search_user')">
                    ...
                    @else
                        <form method="post" action="{{route('admin.messages.send')}}">
                            ...
                            <div class="headind_srch bg-dark">
                                <div class="chat_people header row">
                                    <div class="col-12 col-lg-3">
                                        <p class="font-weight-bold text-white mb-0" style="line-height: 35px">{{trans('backend/labels.backend.messages.select_recipients')}}:</p>
                                    </div>
                            ...
                            <div class="mesgs">
                                <div class="msg_history">
                                    <p class="text-center">{{trans('backend/labels.backend.messages.start_conversation')}}</p>
                                </div>
                                <div class="type_msg">
                                    <div class="input_msg_write">
                                        {{--<input type="text" class="write_msg" placeholder="Type a message"/>--}}
                                        <textarea type="text" name="message" class="write_msg"
                                                  placeholder="{{trans('backend/labels.backend.messages.type_a_message')}}"></textarea>
                                        <button class="msg_send_btn" type="submit">
                                            <i class="icon-paper-plane" style="line-height: 2" aria-hidden="true"></i>
                                        </button>
                                    </div>
