...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <h3 class="page-title d-inline">@lang('backend/labels.backend.categories.title')</h3>
                    ...
                    <div class="table-responsive">
                        ...
                        <table id="myTable"
                            ...
                            <tr>
                                ...
                                <th>Parent</th>
                                <th>@lang('backend/labels.backend.categories.fields.name')</th>
                                <th>@lang('backend/labels.backend.categories.fields.slug')</th>
                                <th>@lang('backend/labels.backend.categories.fields.icon')</th>
                                <th>Total</th>
                                {{-- <th>@lang('backend/labels.backend.categories.fields.formations')</th>
                                <th>@lang('backend/labels.backend.categories.fields.blog')</th> --}}
                                @if( request('show_deleted') == 1 )
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '.delete_warning', function () {
                ...
                const title = (link.attr('data-trans-title')) ? link.attr('data-trans-title') : "{{ trans('backend/labels.backend.categories.not_allowed') }}";
