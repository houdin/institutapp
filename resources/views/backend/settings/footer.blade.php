...
@section('title', __('backend/labels.backend.general_settings.footer.title').' | '.app_name())
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-sm-5">
                    <h3 class="page-title d-inline">@lang('backend/labels.backend.general_settings.footer.title')</h3>
                </div>
            </div>
        </div>
        ...
        <div class="card-body" id="footer">
            ...
            <div class="form-group row">
                {{ html()->label(__('backend/labels.backend.general_settings.footer.short_description'))->class('col-md-2 form-control-label')->for('short_description') }}
                <div class="col-md-8">
                    {{ html()->textarea()
                        ->id('short_description')
                        ->class('form-control')
                        ->placeholder(__('backend/labels.backend.general_settings.footer.short_description'))
                        }}
                </div>
                <div class="col-md-2">
                    <p style="line-height: 35px">
                        <span class="mr-2">{{__('backend/labels.backend.general_settings.contact.show')}}</span> {{ html()->label(html()->checkbox('')
            ...
            @for($i=1; $i<=3; $i++)
                <div class="form-group row">
                    {{ html()->label(__('backend/labels.backend.general_settings.footer.section_'.$i))->class('col-md-2 form-control-label')->for('section'.$i) }}
                ...
                ->class('switch switch-sm switch-3d switch-success')}}
                                <span class="ml-2 title">{{__('backend/labels.backend.general_settings.footer.popular_categories')}}</span>
                            </div>
                     ...
                     . '<span class="switch-label"></span><span class="switch-handle"></span>')
                 ->class('switch switch-sm switch-3d switch-success')}}
                                <span class="ml-2 title">{{__('backend/labels.backend.general_settings.footer.featured_formations')}}</span>
                            </div>
                   ...
                   . '<span class="switch-label"></span><span class="switch-handle"></span>')
               ->class('switch switch-sm switch-3d switch-success')}}
                                <span class="ml-2 title">{{__('backend/labels.backend.general_settings.footer.trending_formations')}}</span>
                    ...
                    . '<span class="switch-label"></span><span class="switch-handle"></span>')
                ->class('switch switch-sm switch-3d switch-success')}}
                                <span class="ml-2 title">{{__('backend/labels.backend.general_settings.footer.popular_formations')}}</span>
                            </div>
                    ...
                    . '<span class="switch-label"></span><span class="switch-handle"></span>')
                ->class('switch switch-sm switch-3d switch-success')}}
                                <span class="ml-2 title">{{__('backend/labels.backend.general_settings.footer.custom_links')}}</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
            ...
            <div class="form-group row">
                {{ html()->label(__('backend/labels.backend.general_settings.footer.social_links'))->class('col-md-2 form-control-label')->for('social_links') }}

                <div class="col-md-4">
                    {{ html()->text('')
                        ->id('social_link_url')
                        ->class('form-control')
                        ->placeholder(__('backend/labels.backend.general_settings.footer.link_url'))
                        }}
                ...
                <div class="col-md-2">
                    <button type="button"
                            class="btn btn-block btn-light add-social-link border">{{ trans('backend/strings.backend.general.app_add')}}
                ...
                <div class="col-md-10 offset-2">
                    <p class="font-italic">{!!  __('backend/labels.backend.general_settings.footer.social_links_note') !!}</p>
                </div>
            ...
            <div class="form-group row">
                {{ html()->label(__('backend/labels.backend.general_settings.footer.bottom_footer'))->class('col-md-2 form-control-label')->for('newsletter_form') }}
                ...
                <div class="col-md-10">
                    <p style="line-height: 35px">
                        ...
                        <span class="ml-3 font-italic">{{__('backend/labels.backend.general_settings.footer.bottom_footer_note')}}</span>
                    </p>
                </div>
            </div>

            <div class="form-group row">
                {{ html()->label(__('backend/labels.backend.general_settings.footer.copyright_text'))->class('col-md-2 form-control-label')->for('copyright_text') }}

                <div class="col-md-8">
                    {{ html()->text('')
                        ->id('copyright_text')
                        ->class('form-control')
                        ->placeholder(__('backend/labels.backend.general_settings.footer.copyright_text'))
                        }}
            ...
            <div class="form-group row">
                {{ html()->label(__('backend/labels.backend.general_settings.footer.footer_links'))->class('col-md-2 form-control-label')->for('footer_links') }}
                ...
                <div class="col-md-2">
                    {{ html()->text('')
                        ...
                        ->class('form-control')
                        ->placeholder(__('backend/labels.backend.general_settings.footer.link_label'))
                        }}
                </div>
                <div class="col-md-2">
                    <button type="button"
                            class="btn btn-block btn-light add-footer-link border">{{ trans('backend/strings.backend.general.app_add')}}
                        <i class="fa fa-plus"></i></button>
                </div>
                <div class="col-md-2">
                    <p style="line-height: 35px">
        ...
        $(document).on('click', '.options input', function () {
            ...
            if ($(this).is(':checked') && $(this).val() == 5) {
                ...
                if ($(button_container).find('.button-wrapper').length == 0) {
                    var name = "{{__('backend/labels.backend.general_settings.footer.link')}}";
                    var link_label = "{{__('backend/labels.backend.general_settings.footer.link_label')}}";
                    var link_url = "{{__('backend/labels.backend.general_settings.footer.link_url')}}";
