...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="page-title d-inline">@lang('backend/labels.backend.forum_category.title')</h3>
                    ...
                    <div class="table-responsive">
                        <table id="myTable"
                            ...
                            <tr>
                                ...
                                <th>@lang('backend/labels.backend.forum_category.fields.parent_category')</th>
                                <th>@lang('backend/labels.backend.forum_category.fields.category')</th>
                                <th>@lang('backend/labels.backend.forum_category.fields.order')</th>
                                <th>@lang('backend/labels.backend.forum_category.fields.color')</th>
