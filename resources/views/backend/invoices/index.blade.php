...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="page-title d-inline">@lang('backend/labels.backend.invoices.title')</h3>
                    ...
                    <div class="table-responsive">
                        <table id="myTable"
                            ...
                            <tr>
                                ...
                                <th>@lang('backend/labels.backend.invoices.fields.order_date')</th>
                                <th>@lang('backend/labels.backend.invoices.fields.amount')</th>
                                    ...
                                    <td>
                                        <a target="_blank" href="{{asset('storage/invoices/'.$item->url)}}"
                                           class="btn mb-1 btn-danger">
                                            @lang('backend/labels.backend.invoices.fields.view')
                                        </a>

                                        <a href="{{route('admin.invoice.download',['order'=>$item->order_id])}}"
                                           class="btn mb-1 btn-success">
                                            @lang('backend/labels.backend.invoices.fields.download')
                                        </a>
                                    </td>
                                </tr>
                            @endforeach
