...
<head>
    ...
    <title>FXinstitut : Certificate of Completion</title>
...
<div class="container-fluid px-0" style="height: 500px">
    <div style="position: relative;text-align: center"
        ...
        <img class="logo" src="{{public_path('storage/logos/'.config('app.logo_b_image'))}}">
        ...
        <div class="col-12 text-block align-self-center">
            ...
            <p style="word-wrap: break-word;white-space: nowrap"><span class="font-weight-bold" style="font-family: DejaVu Sans;">{{$data['formation_name']}}</span>
            </p>
            <p  style="word-wrap: break-word;white-space: nowrap">on <span class="font-weight-bold" style="font-family: DejaVu Sans;">{{config('app.name')}}</span> online formation on <span class="font-weight-bold">{{$data['date']}}</span></p>
        </div>
