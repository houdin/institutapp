        ...
        <div class="px-4 sm:px-6 lg:px-8">
            <div class="container flex justify-center">
                <button @click="openModal = true" type="button"
                    ...
                    <PlusIcon class="mr-3 h-4 w-4 text-gray-400" aria-hidden="true" />NEW ISSUE
                </button>
            </div>

            <Modal type="issue"></Modal>

            <ItemsViewer :data="issues" :header="$page.props.headerTable.issue.issue" type="issue"
