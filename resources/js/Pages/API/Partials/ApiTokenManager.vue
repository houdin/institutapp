    ...
    <div>
        ...
        <JetFormSection @submitted="createApiToken">
            ...
            <template #form>
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <JetTextInput id="name" v-model="createApiTokenForm.name" type="text" class="mt-1 block w-full"
                        autofocus />
                ...
                <div v-if="availablePermissions.length > 0" class="col-span-6">
                    <JetInputLabel for="permissions" value="Permissions" />
            ...
            <template #actions>
                ...
                <JetPrimaryButton :class="{ 'opacity-25': createApiTokenForm.processing }"
        ...
        <JetDialogModal :show="displayingToken" @close="displayingToken = false">
            ...
            <template #content>
                ...
                <div v-if="$p    age.props.jetstream.flash.token"
        ...
        <JetDialogModal :show="managingPermissionsFor != null" @close="managingPermissionsFor = null">
            ...
            <template #footer>
                ...
                <JetPrimaryButton class="ml-3" :class="{ 'opacity-25': updateApiTokenForm.processing }"
