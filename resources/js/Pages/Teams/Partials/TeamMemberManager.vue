    ...
    <div>
            ...
            <JetFormSection @submitted="addTeamMember">
                ...
                <template #form>
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <JetTextInput id="email" v-model="addTeamMemberForm.email" type="email"
                    ...
                    <div v-if="availableRoles.length > 0" class="col-span-6 lg:col-span-4">
                        <JetInputLabel for="roles" value="Role" />
                        ...
                        <div class="relative z-0 mt-1 border border-gray-200 rounded-lg cursor-pointer">
                            <button v-for="( role, i) in availableRoles" :key="role.key" type="button"
                                ...
                                <div
                                    :class="{ 'op    acity-50': addTeamMemberForm.role && addTeamMemberForm.role != role.key }">
                                    <!-- Role Name -->
                ...
                <template #actions>
                    ...
                    <JetPrimaryButton :class="{ 'opacity-25': addTeamMemberForm.processing }"
        ...
        <JetDialogModal :show="currentlyManagingRole" @close="currentlyManagingRole = false">
            ...
            <template #footer>
                ...
                <JetPrimaryButton class="ml-3" :class="{ 'opacity-25': updateRoleForm.processing }"
