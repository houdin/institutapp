    ...
    <div class="container mx-auto">
        ...
        <div class="grid md:grid-cols-3 grid-cols-1 gap-4">
            ...
            <template v-if="formations.data[0]">
                ...
                <div v-for="(item, index) in formations.data" :key="index"
                    class="flex flex-col bg-slate-700 rounded-lg shadow-xl">
            ...
            <h3 v-if="no_formation">Pas de Formation Disponible !</h3>
        ...
        <NewPagination :links="formations.links" />
    </div>
