    ...
    <JetFormSection @submitted="updateProfileInformation">
        ...
        <template #form>
            ...
            <div v-if="$page.props.jetstream.managesProfilePhotos" class="col-span-6 sm:col-span-4">
                ...
                <JetInputLabel for="photo" value="Photo" />
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <JetTextInput id="name" v-model="form.name" type="text" class="mt-1 block w-full" autocomplete="name" />
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <JetTextInput id="email" v-model="form.email" type="email" class="mt-1 block w-full" />
