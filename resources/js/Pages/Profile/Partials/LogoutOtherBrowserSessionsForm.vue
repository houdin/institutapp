    ...
    <JetActionSection>
        ...
        <template #content>
            ...
            <div class="flex items-center mt-5">
                <JetPrimaryButton @click="confirmLogout">
            ...
            <JetDialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    ...
                    <div class="mt-4">
                        <JetTextInput ref="passwordInput" v-model="form.password" type="password"
                            class="mt-1 block w-3/4" placeholder="Password" @keyup.enter="logoutOtherBrowserSessions" />
                ...
                <template #footer>
                    ...
                    <JetPrimaryButton class="ml-3" :class="{ 'opacity-25': form.processing }"
