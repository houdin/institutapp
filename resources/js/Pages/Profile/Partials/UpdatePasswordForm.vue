    ...
    <JetFormSection @submitted="updatePassword">
        ...
        <template #form>
            <div class="col-span-6 sm:col-span-4">
                <JetInputLabel for="current_password" value="Current Password" />
                <JetTextInput id="current_password" ref="currentPasswordInput" v-model="form.current_password"
                    type="password" class="mt-1 block w-full" autocomplete="current-password" />
                <JetInputError :message="form.errors.current_password" class="mt-2" />
            </div>

            <div class="col-span-6 sm:col-span-4">
                <JetInputLabel for="password" value="New Password" />
