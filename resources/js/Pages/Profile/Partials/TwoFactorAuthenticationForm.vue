            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    ...
                    <div v-if="confirming" class="mt-4">
                        ...
                        <JetTextInput id="code" v-model="confirmationForm.code" type="text" name="code"
            ...
            <div class="mt-5">
                <div v-if="!twoFactorEnabled">
                    <JetConfirmsPassword @confirmed="enableTwoFactorAuthentication">
                        <JetPrimaryButton type="button" :class="{ 'opacity-25': enabling }" :disabled="enabling">
                            Enable
                        </JetPrimaryButton>
                    </JetConfirmsPassword>
                </div>
                ...
                <div v-else>
                    <JetConfirmsPassword @confirmed="confirmTwoFactorAuthentication">
                        <JetPrimaryButton v-if="confirming" type="button" class="mr-3"
                            :class="{ 'op acity-25': enabling }" :disabled="enabling">
                            Confirm
                        </JetPrimaryButton>
                    </JetConfirmsPassword>
