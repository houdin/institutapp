        ...
        <div class="relative px-4 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-prose text-lg">
                <h1>
                    ...
                    <span
                        class="mt-2 block text-center text-3xl font-bold leading-8 tracking-tight sm:text-4xl">JavaScript
                        for Beginners</span>
                </h1>
                <p class="mt-8 text-xl leading-8 ">Aliquet nec orci mattis amet quisque ullamcorper neque,
                    nibh
            ...
            <div class="prose prose-lg prose-indigo mx-auto mt-6 ">
                <p>Faucibus commodo massa rhoncus, volutpat. <strong>Dignissim</strong> sed <strong>eget risus
                        enim</strong>. Mattis mauris semper sed amet vitae sed turpis id. Id dolor praesent donec est.
                    Odio
                    penatibus risus viverra tellus varius sit neque erat velit. Faucibus commodo massa rhoncus,
                    volutpat.
