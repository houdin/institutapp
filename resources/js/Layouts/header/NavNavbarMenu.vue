<template>
    ...
    -->
            <svg class="text-gray-400 ml-2 h-5 w-5 transition duration-150 ease-in-out group-hover:text-gray-500"
  ...
  -->
        <div class="absolute left-1/2 z-10 mt-3 w-screen max-w-md -translate-x-1/2 transform px-2 sm:px-0 lg:max-w-3xl">
            <div class="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8 lg:grid-cols-2">
                    <a href="#"
                        ...
                        <div class="ml-4">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Get a better understanding of where your traffic is
                                coming
                                from.</p>
                        </div>
                    </a>
                    ...
                    <a href="#"
                        ...
                        <div class="ml-4">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Speak directly to your customers in a more meaningful
                                way.
                            </p>
                        </div>
                    </a>
                    ...
                    <a href="#"
                        ...
                        <div class="ml-4">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Build strategic funnels that will drive your customers
                                to
                                convert</p>
                        </div>
                    </a>
                    ...
                    <a href="#"
                        ...
                        <div class="ml-4">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Get detailed reports that will help you make more
                                informed
                                decisions</p>
                        </div>
                    </a>
                ...
                <div class="bg-gray-50 p-5 sm:p-8">
                    <a href="#"
                        ...
                        <span class="mt-1 block text-sm text-gray-500">Empower your entire team with even more advanced
                            tools.</span>
                    </a>
                </div>
            </div>
