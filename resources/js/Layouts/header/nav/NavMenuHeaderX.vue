<template>
    <header id="header" :class="{ ' -translate-y-14': hideNavbar }"
        class="sticky top-0 z-30 bg-gray-800 drop-shadow-lg transition duration-500 ease-in-out">
        <Popover as="nav" id="nav" class="" v-slot="{ open }">
            <div class="mx-auto max-w-7xl px-2 sm:px-4 lg:px-8">
                <div class="relative flex h-14 items-center justify-between">
                    <div class="flex items-center px-2 lg:px-0">
                        ...
                        <PopoverGroup class="hidden lg:ml-6 lg:block">
                            <div class="flex">
