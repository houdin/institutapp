...
-->
<template>
    <TransitionRoot as="template" :show="openSlide">
        <Dialog as="div" class="relative z-10" @close="openSlide = false">
                                ...
                                <form class="flex h-full flex-col divide-y divide-gray-200 bg-white shadow-xl">
                                    <div class="h-0 flex-1 overflow-y-auto">
                                        <div class="bg-indigo-700 py-6 px-4 sm:px-6">
                                            <div class="flex items-center justify-between">
                                                <DialogTitle class="text-lg font-medium text-white">Edit {{ type }}
                                                </DialogTitle>
                                                ...
                                                <div class="space-y-6 pt-6 pb-5">
                                                    <div>
                                                        <label for="project-name"
                                                            class="block text-sm font-medium text-gray-900">Project
                                                            name</label>
                                                        <div class="mt-1">
                                                    ...
                                                    <fieldset>
                                                        <legend class="text-sm font-medium text-gray-900">Privacy
                                                        </legend>
                                                            ...
                                                            <div class="relative flex items-start">
                                                                ...
                                                                <div class="pl-7 text-sm">
                                                                    ...
                                                                    <p id="privacy-public-description"
                                                                        class="text-gray-500">Everyone with the link
                                                                ...
                                                                <div class="relative flex items-start">
                                                                    ...
                                                                    <div class="pl-7 text-sm">
                                                                        ...
                                                                        <p id="privacy-private-description"
                                                                            class="text-gray-500">You are the only one
                                    ...
                                    <div class="flex flex-shrink-0 justify-end px-4 py-4">
                                        <button type="button"
                                            ...
                                            @click="openSlide = false">Cancel</button>
                                        <button type="submit"
                                            class="ml-4 inline-flex justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Save</button>
                                    </div>
                                </form>
                            </DialogPanel>
                        </TransitionChild>
...
const openSlide = inject('openSlide');
