  ...
  <div class="row">
    ...
    <div v-if="Object.keys(data).length > 0" class="row">
      ...
      <div class="crs-details-item border-bottom-0 mb-0">
        ...
        <div class="crs-single-text">
          <div class="crs-title mt10 headline position-relative">
            <h3>
              <router-link v-if="data.formation.slug" :to="{ name: 'formations.show', params: { slug:data.formation.slug }}"><b>{{data.formation.title}}</b></router-link>

              <span v-if="data.formation.trending == 1" class="trend-badge text-uppercase ">
                {{ trans.get('labels.frontend.badges.trending')}}<i class="fas fa-bolt"></i></span>

            </h3>
          </div>
          <div class="crs-details-content">
            <p v-if="data.formation.description">
      ...
      <div class="crs-single-pic d-flex align-items-center overflow-hidden mb30">
        <img v-if="Object.keys(data.formation.image).length > 0" :src="data.formation.image.url" class="w-100" alt="">
      </div>
      <div class="col-md-8">
        <div class="crs-details-item border-bottom-0 mb-0">
          ...
          <div class="crs-single-text">
            ...
            <media-formation :media-video="data.formation.media_video"></media-formation>

            <div v-if="Object.keys(data.formation.formation_timeline).length > 0" class="crs-details-category ul-li">
        ...
        <div class="affiliate-market-guide mb65">
          ...
          <div class="affiliate-market-accordion">
            <modules-formation v-if="Object.keys(data.formation.formation_timeline).length > 0" :modules="data.formation.formation_timeline" :completed-modules="data.completed_modules"></modules-formation>
          </div>
        </div>
        <!-- /market guide -->
      ...
      <div class="col-md-4">
        <sidebar-bundle :formation="data.formation" :purchased="data.purchased_formation" :continue-formation="data.continue_formation"></sidebar-bundle>
      </div>
