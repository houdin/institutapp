<template>
  <section class="hero-section">
      ...
      <div class="owl-stage-outer">
        <div class="owl-stage"
          ...
          <div class="owl-item cloned" style="width: 1440px;">
            <div class="hs-item set-bg" data-setbg="img/bg.jpg" style="background-image: url(&quot;img/bg.jpg&quot;);">
              <div class="container">
                <div class="row">
          ...
          <div class="owl-item cloned" style="width: 1440px;">
            <div class="hs-item set-bg" data-setbg="/bg-2.jpg" style="background-image: url('/bg-2.jpg');">
              <div class="container">
                <div class="row">
                  <div class="col-xl-6 col-lg-7 text-white">
                    <span>New Arrivals</span>
          ...
          <div class="owl-item active" style="width: 1440px;">
            <div class="hs-item set-bg" data-setbg="/bg.jpg" style="background-image: url('/bg.jpg');">
              <div class="container">
                <div class="row">
                  <div class="col-xl-6 col-lg-7 text-white">
                    <span>New Arrivals</span>
      ...
      <div class="slider-nav-warp">
        <div class="slider-nav">
          <div class="owl-nav"><button type="button" role="presentation" class="owl-prev"><i
                class="flaticon-left-arrow-1"></i></button><button type="button" role="presentation" class="owl-next"><i
                class="flaticon-right-arrow-1"></i></button></div>
    ...
    <!-- <div class="container">
      <div class="slide-num-holder" id="snh-1"><span> 1</span><span>2</span></div>
    </div> -->
  </section>
</template>
