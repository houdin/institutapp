...
export default {
  ...
  mounted() {
    ...
    this.post_url = this.$laravel.urls.shopping_order_billing_post;
    ...
    this.stripe = StripeCheckout.configure({
      ...
      token: function (token) {
        ...
        axios
          .post(this.$lLaravel.urls.shopping_order_billing_post, self.formData)
          .then((response) => self.emitSuccess(response.data))
          .catch((error) => self.emitError(error.response.data));
      },
    });
  },
