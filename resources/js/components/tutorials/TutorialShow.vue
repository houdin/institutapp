<template>
  ...
  <div v-if="Object.keys(data).length > 0" class="row">
    <div class="col">
      <div v-if="Object.keys(data.tutorial.image).length > 0" class="crs-single-pic mb30" :style="'background-image: url(' + data.tutorial.image.url +')'">
  ...
  <div class="row">
    <div class="col-md-8">
      ...
      <div class="crs-details-item border-bottom-0 mb-0">
        ...
        <div class="crs-single-text">
          <div class="crs-title mt10 headline position-relative">
            <h3>
              <router-link v-if="data.tutorial.slug" :to="{ name: 'formations.show', params: { slug:data.tutorial.slug }}"><b>{{data.tutorial.title}}</b></router-link>
          ...
          <media-tutorial :media-video="data.tutorial.media_video"></media-tutorial>
      ...
      <div v-if="Object.keys(data.purchased_tutorial).length > 0" class="crs-comment">
    ...
    <div class="col-md-4">
      <sidebar-tutorial :formation="data.tutorial" :purchased="data.purchased_tutorial" :continue-tutorial="data.continue_tutorial"></sidebar-tutorial>
    </div>
  </div>
