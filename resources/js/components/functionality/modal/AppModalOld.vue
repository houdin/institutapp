<template>
  ...
  <div v-if="showRef" :class="{'modal':true, 'fade': noAnim, 'd-block': noAnim ? false : showRef}" :id="modalId"
    :data-bs-backdrop="modalstatic ? 'static' : null" :data-bs-keyboard="modalstatic ? false : true" tabindex="-1"
    aria-hidden="true" v-show="showRef" @click="close">
