<template>
  <div class="card">
    <div class="card-body">
      <div v-if="errors.commentable_type" class="alert alert-danger" role="alert">
        {{ $errors.commentable_type[0] }}
      </div>
      <div v-if="errors.commentable_id" class="alert alert-danger" role="alert">
        {{ $errors.commentable_id[0] }}
      </div>
