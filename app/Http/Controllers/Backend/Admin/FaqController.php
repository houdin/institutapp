...
class FaqController extends BackendBaseController
{
    ...
    public function store(StoreFaqsRequest $request)
    {
        ...
        return redirect()->route('admin.faqs.index')->with('success', trans('alerts.backend.general.created'));
    }
    ...
    public function update(UpdateFaqsRequest $request, $id)
    {
        ...
        return redirect()->route('admin.faqs.index')->with('success', trans('alerts.backend.general.updated'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.faqs.index')->with('success', trans('alerts.backend.general.deleted'));
    }
