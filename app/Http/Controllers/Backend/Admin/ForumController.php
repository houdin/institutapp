...
class ForumController extends BackendBaseController
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.forums-category.index')->with('success', trans('alerts.backend.general.created'));
    }
