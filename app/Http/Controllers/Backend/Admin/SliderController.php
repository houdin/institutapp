...
class SliderController extends BackendBaseController
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.sliders.index')->with('success', trans('alerts.backend.general.created'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.sliders.index')->with('success', trans('alerts.backend.general.updated'));
    }
