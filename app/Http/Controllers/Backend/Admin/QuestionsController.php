...
class QuestionsController extends BackendBaseController
{
    ...
    public function store(StoreQuestionsRequest $request)
    {
        ...
        return redirect()->route('admin.questions.index')->with('success', trans('alerts.backend.general.created'));
    }
    ...
    public function update(UpdateQuestionsRequest $request, $id)
    {
        ...
        return redirect()->route('admin.questions.index')->with('success', trans('alerts.backend.general.updated'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.questions.index')->with('success', trans('alerts.backend.general.deleted'));
    }
    ...
    public function restore($id)
    {
        ...
        return redirect()->route('admin.questions.index')->with('success', trans('alerts.backend.general.restored'));
    }
