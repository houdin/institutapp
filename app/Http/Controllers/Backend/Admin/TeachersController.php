...
class TeachersController extends BackendBaseController
{
    use FileUploadTrait;
    ...
    public function getData(Request $request)
    {
        ...
        return DataTables::of($teachers)
            ...
            ->addColumn('actions', function ($q) use ($has_view, $has_edit, $has_delete, $request) {
                ...
                $view .= '<a class="btn btn-warning mb-1" href="' . route('admin.formations.index', ['teacher_id' => $q->id]) . '">' . trans('labels.backend.formations.title') . '</a>';
    ...
    public function store(StoreTeachersRequest $request)
    {
        ...
        return redirect()->route('admin.teachers.index')->with('success', trans('alerts.backend.general.created'));
    }
    ...
    public function update(UpdateTeachersRequest $request, $id)
    {
        ...
        return redirect()->route('admin.teachers.index')->with('success', trans('alerts.backend.general.updated'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.teachers.index')->with('success', trans('alerts.backend.general.deleted'));
    }
    ...
    public function restore($id)
    {
        ...
        return redirect()->route('admin.teachers.index')->with('success', trans('alerts.backend.general.restored'));
    }
