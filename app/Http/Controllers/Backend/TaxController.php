...
class TaxController extends BackendBaseController
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.tax.index')->with('success', trans('alerts.backend.general.created'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($tax != null) {
            ...
            $tax->rate = $request->rate;
            $tax->save();
            return redirect()->route('admin.tax.index')->with('success', trans('alerts.backend.general.updated'));
        }
        return abort(404);
    }
