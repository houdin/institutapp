...
class UserController extends BackendBaseController
{
    ...
    public function store(StoreUserRequest $request)
    {
        ...
        return redirect()->route('admin.auth.user.index')->with('success', __('alerts.backend.users.created'));
    }
    ...
    public function update(UpdateUserRequest $request, User $user)
    {
        ...
        return redirect()->route('admin.auth.user.index')->with('success', __('alerts.backend.users.updated'));
    }
    ...
    public function destroy(ManageUserRequest $request, User $user)
    {
        ...
        return redirect()->route('admin.auth.user.index')->with('success', __('alerts.backend.users.deleted'));
    }
}
