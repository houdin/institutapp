...
class RoleController extends BackendBaseController
{
    ...
    public function store(StoreRoleRequest $request)
    {
        ...
        return redirect()->route('admin.auth.role.index')->with('success', __('alerts.backend.roles.created'));
    }
    ...
    {
        if ($role->isAdmin()) {
            return redirect()->route('admin.auth.role.index')->with('danger', 'You can not edit the administrator role.');
        }
    ...
    public function update(UpdateRoleRequest $request, Role $role)
    {
        ...
        return redirect()->route('admin.auth.role.index')->with('success', __('alerts.backend.roles.updated'));
    }
    ...
    {
        if ($role->isAdmin()) {
            return redirect()->route('admin.auth.role.index')->with('danger', __('exceptions.backend.access.roles.cant_delete_admin'));
        }
        ...
        return redirect()->route('admin.auth.role.index')->with('success', __('alerts.backend.roles.deleted'));
    }
}
