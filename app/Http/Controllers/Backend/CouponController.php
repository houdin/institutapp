...
class CouponController extends BackendBaseController
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.coupons.index')->with('success', trans('alerts.backend.general.created'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($coupon != null) {
            ...
            $coupon->per_user_limit = $request->per_user_limit;
            $coupon->save();
            return redirect()->route('admin.coupons.index')->with('success', trans('alerts.backend.general.updated'));
        }
        return abort(404);
    }
