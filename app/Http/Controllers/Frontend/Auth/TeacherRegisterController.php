...
class TeacherRegisterController extends FrontendBaseController
{
    /**
    ...
    public function register(TeacherRegisterRequest $request)
    {
        ...
        return redirect()->route('frontend.index')->with('success', trans('labels.frontend.modal.registration_message'))->with(['openModel' => true]);
    }
}
