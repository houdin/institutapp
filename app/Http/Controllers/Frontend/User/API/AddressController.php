...
use App\Http\Requests\ecommerce\UserAddressRequest;
...
class AddressController extends AbstractUserAPIController
{
    ...
    public function store(UserAddressRequest $request)
    {
        try {
            ...
            return $this->hasError(
                'Sorry there was an error creating your new address.  Please try again',
                422
            );
        }
    ...
    public function update(UserAddressRequest $request, Address $address)
    {
        ...
        try {
            ...
            return $this->hasError(
                'Sorry there was an error updating your new address.  Please try again',
                422
            );
        }
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            return $this->hasError(
                'Sorry there was an error deleting your new address.  Please try again',
                422
            );
        }
